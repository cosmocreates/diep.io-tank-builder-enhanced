import { strokeWidths } from './settings.js';
import { circleClosingPoint } from './settings.js';
...
export class StatusIndicator extends SceneObject {
    constructor() {
        super();
...
export class Player extends SceneObject {
    ...
    render(context) {
        console.log(this.radius, (this.arena.width + this.arena.height) / 2)
...
export class OutOfBounds extends SceneObject {
    constructor(x, y) {
        super();
        this.x = x;
        this.y = y;
...
export class Arena extends SceneObject {
